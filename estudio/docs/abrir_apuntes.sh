...
# Pedir nivel
read -p "¿Qué nivel quieres estudiar (1-6)? " nivel

archivo=~/termux-setup/dotfiles/practica_bash/proyectos/bash/nivel${nivel}/apuntes.md
registro=~/termux-setup/dotfiles/practica_bash/proyectos/bash/nivel${nivel}/completados.txt
meta=10
